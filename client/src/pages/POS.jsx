...
export default function POS() {
  ...
  useEffect(() => {
    // موبايل — مش بنعمل auto-focus عشان بيفتح الكيبورد
    if (isMobile) {
    ...
    // لما يضغط على أي مكان مش input نرجع الـ focus للـ scanner
    const handleClick = (e) => {
      if (
  ...
  const handleSale = async () => {
    ...
    try {
      ...
      fetchMedicines(); // ✅ تحديث المخزون فوراً بعد البيع
